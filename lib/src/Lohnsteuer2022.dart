...
/// 
 ...
 class Lohnsteuer2022 implements LohnsteuerInterface {
	...
	/// Teilbetragssatz der Vorsorgepauschale für die Rentenversicherung (2 Dezimalstellen)
	 BigDecimal TBSVORV = BigDecimal(0);
	...
	@override
	 void setKvz(BigDecimal arg0) { KVZ = arg0; }
	...
	@override
	 void setMbv(BigDecimal arg0) { MBV = arg0; }
	...
	@override
	 BigDecimal getVfrb() { return VFRB; }
	...
	@override
	 BigDecimal getVfrbs2() { return VFRBS2; }

	@override
	 BigDecimal getVfrbs1() { return VFRBS1; }

	@override
	 BigDecimal getVkvlzz() { return VKVLZZ; }

	@override
	 BigDecimal getWvfrbm() { return WVFRBM; }
	...
	@override
	 BigDecimal getVkvsonst() { return VKVSONST; }

	@override
	 BigDecimal getWvfrb() { return WVFRB; }

	@override
	 BigDecimal getSolzlzz() { return SOLZLZZ; }

	@override
	 BigDecimal getWvfrbo() { return WVFRBO; }
	...
	/// Zuweisung von Werten für bestimmte Sozialversicherungsparameter  PAP Seite 15
	 void MPARA() {
		...
		if(KRV < 2) /** &lt; = < */{
			if(KRV == 0) {
				BBGRV = BigDecimal(84600);/** Geändert für 2022 */
			} else {
				BBGRV = BigDecimal(81000);/** Geändert für 2022 */
			}
			RVSATZAN = BigDecimal.valueOf(0.093);/** Neu 2019 */
			TBSVORV = BigDecimal.valueOf(0.88);/** Geändert für 2022 */
		} else {/** Nichts zu tun */
		}
		BBGKVPV = BigDecimal(58050);/** Geändert für 2021 */
		bd = BigDecimal(2);/** Neu 2019 */
		...
		W1STKL5 = BigDecimal(11793);/** 2022.2 */
		W2STKL5 = BigDecimal(29298);
		W3STKL5 = BigDecimal(222260);
		GFB = BigDecimal(10347);/** 2022.2 *//** Ende Geändert für 2022 *//** Anfang Geändert für 2021 */
		SOLZFREI = BigDecimal(16956);/** Ende Geändert für 2021 */
	}
