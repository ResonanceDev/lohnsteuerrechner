...
class PapFile {
  ...
  PapFile(this.name, this.xmlfileName, this.year, this.from, this.to);
}

class Generator {
  static final List<PapFile> PAP_FILES = [
    PapFile("Lohnsteuer2024","Lohnsteuer2024.xml", 2024, 1, null),
    PapFile("Lohnsteuer2023AbJuli","Lohnsteuer2023AbJuli.xml", 2023, 7, 12),
    PapFile("Lohnsteuer2023","Lohnsteuer2023.xml", 2023, 1, 6),
    PapFile("Lohnsteuer2022","Lohnsteuer2022.xml", 2022, 1, 12),
    PapFile("Lohnsteuer2021","Lohnsteuer2021.xml", 2021, 1, 12),
    PapFile("Lohnsteuer2020","Lohnsteuer2020.xml", 2020, 1, 12),
    PapFile("Lohnsteuer2019","Lohnsteuer2019.xml", 2019, 1, 12),
    PapFile("Lohnsteuer2018","Lohnsteuer2018.xml", 2018, 1, 12),
    PapFile("Lohnsteuer2017","Lohnsteuer2017.xml", 2017, 1, 12),
    PapFile("Lohnsteuer2016","Lohnsteuer2016.xml", 2016, 1, 12),
    PapFile("Lohnsteuer2015ezember","Lohnsteuer2015Dezember.xml", 2015, 12, 12),
    PapFile("Lohnsteuer2015","Lohnsteuer2015.xml", 2015, 1, 11),
    PapFile("Lohnsteuer2014","Lohnsteuer2014.xml", 2014, 1, 12),
    PapFile("Lohnsteuer2013","Lohnsteuer2013.xml", 2013, 1, 12),
    PapFile("Lohnsteuer2012","Lohnsteuer2012.xml", 2012, 1, 12),
    PapFile("Lohnsteuer2011Dezember","Lohnsteuer2011Dezember.xml", 2011, 12, 12),
    PapFile("Lohnsteuer2011","Lohnsteuer2011.xml", 2011, 1, 11),
    PapFile("Lohnsteuer2010","Lohnsteuer2010.xml", 2010, 1, 12),
    PapFile("Lohnsteuer2009","Lohnsteuer2009.xml", 2009, 1, 12),
    PapFile("Lohnsteuer2008","Lohnsteuer2008.xml", 2008, 1, 12),
    PapFile("Lohnsteuer2007","Lohnsteuer2007.xml", 2007, 1, 12),
    PapFile("Lohnsteuer2006","Lohnsteuer2006.xml", 2006, 1, 12),
  ];
  ...
  static String getFilePath(List<String> elems) {
    return elems.join(Platform.pathSeparator);
  }

  static Directory getDirectory(List<String> elems) {
  ...
  Future<void> parse() async {
    ...
    PapHandler h = PapHandler(pf, path, piw);
    h.parse(document);
...
class PapHandler {
  ...
  PapHandler(this.pf, this.path, this.piw);
  ...
  void parse(XmlDocument document) {
    for (var element in document.findAllENlements()) {
...
class PAPCommentReader {
  ...
  bool variables = false, constants = false, methods = false, method = false, failed = false;

  String? lastComment;

  PAPCommentReader(this.path, this.pf, this.pw, this.piw,this.lastComment, this.failed);
...
class PapInterfaceWriter extends AbstractWriter {
  PapInterfaceWriter(super.fileName) {
...
class PapWrapperWriter extends AbstractWriter {
  PapWrapperWriter(super.fileName) {
    writeln("package de.powerproject.lohnpap.pap;");
    writeln();
