...
/// 
 ...
 class Lohnsteuer2019 implements LohnsteuerInterface {
	...
	/// Zuweisung von Werten für bestimmte Sozialversicherungsparameter  PAP Seite 14
	 void MPARA() {
		...
		if(KRV < 2) /** &lt; = < */{
			if(KRV == 0) {
				BBGRV = BigDecimal(80400);/** Neu 2019 */
			} else {
				BBGRV = BigDecimal(73800);/** Neu 2019 */
			}
			RVSATZAN = BigDecimal.valueOf(0.093);/** Neu 2019 */
			TBSVORV = BigDecimal.valueOf(0.76);/** Neu 2019 */
		} else {/** Nichts zu tun */
		}
		BBGKVPV = BigDecimal(54450);/** Neu 2019 */
		...
		W1STKL5 = BigDecimal(10635);
		W2STKL5 = BigDecimal(27980);
		W3STKL5 = BigDecimal(212261);
		GFB = BigDecimal(9168);/** Ende Neu 2019 */
		SOLZFREI = BigDecimal(972);
	}
