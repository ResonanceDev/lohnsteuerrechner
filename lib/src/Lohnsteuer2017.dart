 ...
 class Lohnsteuer2017 implements LohnsteuerInterface {
	...
	/// Zuweisung von Werten für bestimmte Sozialversicherungsparameter  PAP Seite 14
	 void MPARA() {
		...
		if(KRV < 2) /** &lt; = < */{
			if(KRV == 0) {
				BBGRV = BigDecimal(76200);/** Neu 2017 */
			} else {
				BBGRV = BigDecimal(68400);/** Neu 2017 */
			}
			RVSATZAN = BigDecimal.valueOf(0.0935);
			TBSVORV = BigDecimal.valueOf(0.68);/** Neu 2017 */
		} else {/** Nichts zu tun */
		}
		BBGKVPV = BigDecimal(52200);/** Neu 2017 */
		...
		W1STKL5 = BigDecimal(10240);
		W2STKL5 = BigDecimal(27029);
		W3STKL5 = BigDecimal(205043);
		GFB = BigDecimal(8820);/** Ende Neu 2017 */
