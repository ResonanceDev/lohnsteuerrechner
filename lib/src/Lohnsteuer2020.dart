 ...
 class Lohnsteuer2020 implements LohnsteuerInterface {
	...
	/// Zuweisung von Werten für bestimmte Sozialversicherungsparameter  PAP Seite 14
	 void MPARA() {
		...
		if(KRV < 2) /** &lt; = < */{
			if(KRV == 0) {
				BBGRV = BigDecimal(82800);/** Neu 2020 */
			} else {
				BBGRV = BigDecimal(77400);/** Neu 2020 */
			}
			RVSATZAN = BigDecimal.valueOf(0.093);/** Neu 2019 */
			TBSVORV = BigDecimal.valueOf(0.8);/** Neu 2020 */
		} else {/** Nichts zu tun */
		}
		BBGKVPV = BigDecimal(56250);/** Neu 2020 */
		...
		W1STKL5 = BigDecimal(10898);
		W2STKL5 = BigDecimal(28526);
		W3STKL5 = BigDecimal(216400);
		GFB = BigDecimal(9408);/** Ende Neu 2020 */
