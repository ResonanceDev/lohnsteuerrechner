...
/// 
 ...
 class Lohnsteuer2021 implements LohnsteuerInterface {
	...
	/// Zuweisung von Werten für bestimmte Sozialversicherungsparameter  PAP Seite 15
	 void MPARA() {
		...
		if(KRV < 2) /** &lt; = < */{
			if(KRV == 0) {
				BBGRV = BigDecimal(85200);/** Geändert für 2021 */
			} else {
				BBGRV = BigDecimal(80400);/** Geändert für 2021 */
			}
		...
		W1STKL5 = BigDecimal(11237);
		W2STKL5 = BigDecimal(28959);
		W3STKL5 = BigDecimal(219690);
		GFB = BigDecimal(9744);
