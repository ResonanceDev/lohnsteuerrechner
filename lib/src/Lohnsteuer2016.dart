 ...
 class Lohnsteuer2016 implements LohnsteuerInterface {
	...
	/// Zuweisung von Werten für bestimmte Sozialversicherungsparameter  PAP Seite 14
	 void MPARA() {
		...
		if(KRV < 2) /** &lt; = < */{
			if(KRV == 0) {
				BBGRV = BigDecimal(74400);/** Neu 2016 */
			} else {
				BBGRV = BigDecimal(64800);/** Neu 2016 */
			}
			RVSATZAN = BigDecimal.valueOf(0.0935);
			TBSVORV = BigDecimal.valueOf(0.64);/** Neu 2016 */
		} else {/** Nichts zu tun */
		}
		BBGKVPV = BigDecimal(50850);/** Neu 2016 */
		...
		W1STKL5 = BigDecimal(10070);
		W2STKL5 = BigDecimal(26832);
		W3STKL5 = BigDecimal(203557);
		GFB = BigDecimal(8652);
		SOLZFREI = BigDecimal(972);/** Ende Neu 2016 */
	}
