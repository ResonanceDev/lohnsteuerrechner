...
class Lohnsteuer2024 implements LohnsteuerInterface {
  ...
  @override
  void setPva(BigDecimal arg0) { PVA = arg0; }
  ...
  if(KRV < 2) /** &lt; = < */{
  if(KRV == 0) {
  BBGRV = BigDecimal(90600);/** Geändert für 2024 */
  } else {
  BBGRV = BigDecimal(89400);/** Geändert für 2024 */
  }
  RVSATZAN = BigDecimal.valueOf(0.093);/** Neu 2019 */
  } else {/** Nichts zu tun */
  }
  BBGKVPV = BigDecimal(62100);/** Geändert für 2024 */
  ...
  W1STKL5 = BigDecimal(13279);/** geändert 2024 */
  W2STKL5 = BigDecimal(33380);/** geändert 2024 */
  W3STKL5 = BigDecimal(222260);
  GFB = BigDecimal(11604);/** geändert 2024 */
  SOLZFREI = BigDecimal(18130);/** geändert 2024 */
  }
